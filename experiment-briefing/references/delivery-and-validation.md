...
重点判断自动脚本判断不了的问题：图是否被压扁、标题是否太长、首屏是否堆满、图例是否难懂、重要 caveat 是否被埋没。
...
页面旁边至少放一份 CSV 或 JSON。

它不一定被网页读取，但必须让别人能复核、切片或在 Excel/Python 里继续分析，而不是只能从截图抄数。
